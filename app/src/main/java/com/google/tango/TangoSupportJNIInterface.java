...
class TangoSupportJNIInterface {
	public static int doubleTransformPointCloud(double[] matrixTransform, com.google.atap.tangoservice.TangoPointCloudData inputCloud, com.google.atap.tangoservice.TangoPointCloudData outputCloud) {
		return 1;}
	...
	public static int transformPointCloud(float[] matrixTransform, com.google.atap.tangoservice.TangoPointCloudData inputCloud, com.google.atap.tangoservice.TangoPointCloudData outputCloud) {
		return 1;}
	...
	public static int upsampleImageBilateral(boolean approximate, com.google.atap.tangoservice.TangoPointCloudData pointCloud, TangoImageBuffer imageBuffer, com.google.atap.tangoservice.TangoPoseData colorCameraTPointCloud, ByteDepthBuffer byteDepthBuffer) {
		return 1;}

	public static int upsampleImageNearestNeighbor(com.google.atap.tangoservice.TangoPointCloudData pointCloud, int imageWidth, int imageHeight, com.google.atap.tangoservice.TangoPoseData colorCameraTPointCloud, ByteDepthBuffer byteDepthBuffer) {
		return 1;}

	public static int findCorrespondenceSimilarityTransform(double[][] srcPoints, double[][] destPoints, double[] srcTdest) {
		return 1;}

	public static int getDepthAtPointBilateral(com.google.atap.tangoservice.TangoPointCloudData pointCloud, double[] pointCloudTranslation, double[] pointCloudOrientation, TangoImageBuffer imageBuffer, float u, float v, int displayRotation, double[] colorCameraTranslation, double[] colorCameraOrientation, float[] colorCameraPoint) {
		return 1;}

	public static int getPoseAtTime(double timestamp, int baseFrame, int targetFrame, int baseEngine, int targetEngine, int rotationIndex, com.google.atap.tangoservice.TangoPoseData enginePose) {
		return 1;}

	public static int getDepthAtPointNearestNeighbor(com.google.atap.tangoservice.TangoPointCloudData pointCloud, double[] pointCloudTranslation, double[] pointCloudOrientation, float u, float v, int displayRotation, double[] colorCameraTranslation, double[] colorCameraOrientation, float[] colorCameraPoint) {
		return 1;}
