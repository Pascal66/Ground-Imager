...
//import com.test.tango.Tango;
//import com.test.tango.TangoPointCloudManager;
...
//import com.google.tango.Tango;
//import com.google.atap.tangoservice.TangoCameraIntrinsics;
//import com.google.atap.tangoservice.TangoConfig;
//import com.google.tango.TangoCoordinateFramePair;
//import com.google.tango.TangoErrorException;
//import com.google.atap.tangoservice.TangoEvent;
//import com.google.tango.TangoException;
//import com.google.tango.TangoInvalidException;
//import com.google.tango.TangoOutOfDateException;
//import com.google.atap.tangoservice.TangoPointCloudData;
//import com.google.tango.TangoPointCloudManager;
//import com.google.atap.tangoservice.TangoPoseData;
//import com.google.tango.TangoSupport;
//import com.google.tango.TangoXyzIjData;
...
//	Config arConfig;
	...
	protected void onResume() {
		...
		mSamplingRate = (long) sharedPreferences.getInt("sample_rate", 100);
	...
	protected void onStart() {
		...
		if (checkAndRequestPermissions()) {
			Log.e(TAG, "onStart.bindTangoService");
			bindTangoService();
		}
	}
	...
	private void bindTangoService() {
		...
		Log.e(TAG, "bindTangoService.new Tango()");
		mTango = new Tango(MainActivity.this, new Runnable() {
			...
			public void run() {
				...
				synchronized (MainActivity.this) {
					try {
						Log.e(TAG, "setupTangoConfig");
						mConfig = setupTangoConfig(mTango);
						Log.e(TAG, "mTangoConnect");
						mTango.connect(mConfig);
						Log.e(TAG, "startupTango");
						startupTango();
						Log.e(TAG, "TangoSupportInitialize");
						TangoSupport.initialize(mTango);
						Log.e(TAG, "connectRenderer");
						connectRenderer();
						mIsConnected = true;
						Log.e(TAG, "setDisplayRotation");
						setDisplayRotation();
	...
	private void startupTango() {
		...
		mTango.connectListener(framePairs, new Tango.TangoUpdateCallback()/*OnTangoUpdateListener()*/ {
			@Override
				...
				try {
					synchronized (MainActivity.this) {
						...
						if (mConnectedTextureIdGlThread != mRenderer.getTextureId()) {
							...
							Log.i(TAG, "connected to texture id: " + mRenderer.getTextureId());
						}
	...
	private float[] doFitPlane(float u, float v, double rgbTimestamp) {
		...
		if (depthToColorPose.statusCode != TangoPoseData.POSE_VALID) {
			Log.w(TAG, "Could not get a valid pose from depth camera"
	...
	public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
		...
		if (hasPermission()) {
			Log.e(TAG, "onRequestPermissionResult.bindTangoService");
			bindTangoService();
		} else {
